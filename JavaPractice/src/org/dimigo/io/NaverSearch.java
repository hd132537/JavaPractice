	...
	public static void main(String[] args) {		
	    ...
	    try {
	        ...
	        for(int i=0; i<movieList.size(); i++){
	        	...
	        	System.out.print((i+1) + ", " + movieList.get(i).getTitle() + " - " + "{" + movieList.get(i).getActors() + "}" + "\n"); 

	        }
	        
	        try(BufferedWriter bw1 = new BufferedWriter(new FileWriter("files/movies.txt"));){
